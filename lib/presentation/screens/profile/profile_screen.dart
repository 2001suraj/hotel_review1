...
class ProfileScreen extends StatelessWidget {
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  gradient: LinearGradient(
                      colors: [Colors.pink.withOpacity(0.6), Colors.purple.withOpacity(0.4), Colors.cyan.withOpacity(0.6)],
  ...
  ListTile buildListTile({required VoidCallback tap, required String text, required IconData iconData}) {
    return ListTile(
      leading: Icon(
        iconData,
        color: Colors.white,
